...
const MealDetails = () => {
  ...
  useEffect(() => {
    const fetchMeal = async () => {
      try {
        const response = await fetch(`https://hotel-management-server-dun.vercel.app/menu/${id}`);
  ...
  const handleLike = async () => {
    ...
    try {
      const response = await fetch("https://hotel-management-server-dun.vercel.app/meal-request", {
        method: "POST",
