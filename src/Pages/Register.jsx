...
//             email,
//             name,
//             profilePicture, // Optional: save the image if you want to
//           };
...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const profilePicture = await uploadImageToImageBB(file);
      if (!profilePicture) {
      ...
      // Save user details to AuthContext and localStorage
